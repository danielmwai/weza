...
//	public @ResponseBody
//	Map<String, String>  getModuleEvaluationTemplate(@PathVariable String username, @PathVariable String moduleId, HttpServletRequest request) {
//
//		User user = null;
...
//						.getEvaluationTemplateByModule(Long.valueOf(moduleId));
//			} catch (NumberFormatException e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			} catch (EvaluationTemplateDoesNotExistException e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			}
...
//	public @ResponseBody
//	EvaluationTestBean getEvaluationTemplateQuestions(@PathVariable String username, @PathVariable String testId, HttpServletRequest request) throws Exception {
//		EvaluationTemplate evaluationTemplate = evaluationTemplateService
//				.findEvaluationTemplateById(Long.valueOf(testId));
//		
//		User user = null;
//		try {
//			user = userDao.findUser(username);
...
//			}
//
//			evaluation.setEvaluationTemplate(evaluationTemplate);
...
//		EvaluationTemplate evaluationTemplate = evaluationTemplateService
//				.findEvaluationTemplateById(Long.valueOf(id));
//		
//		User user = null;
//		try {
//			user = userDao.findUser(username);
...
//				testBean.setQuestionText(question.getText());
//				testBean.setChoises(choices);
//				testBean.setModule(studentEvaluation.getEvaluationTemplate()
//						.getModule().getName());
//				testBean.setCorrectAnswers(correct);
...
//			if (studentEvaluation.getEvaluationTemplate().getModule()
//					.isEvaluated()) {
//				double factor = studentEvaluation.getEvaluationTemplate()
//						.getFactoring();
...
//		// and exercises
//		if (percentageScore >= studentEvaluation.getEvaluationTemplate()
//				.getPassmark()) {
...
//				.getEvaluationTemplate().getPassmark()) ? "passed" : "failed");
//
//		return model;
//
//	}
