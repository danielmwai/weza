...
//import com.tunaweza.web.mentor.AddMentorBean;
//import com.tunaweza.web.mentor.EditMentorBean;
//import com.tunaweza.web.mentor.MentorModulesBean;
//import com.tunaweza.web.mentor.TransactionsModuleBean;
//import com.tunaweza.web.mentoring.AddMentorTemplateBean;
//import com.tunaweza.web.mentoring.AssignMentorMentorTemplateBean;
//import com.tunaweza.web.mentoring.AssignMentorTemplateExercisesBean;
...
//
//	@RequestMapping(method = RequestMethod.GET, value = NEW_MENTOR)
...
//		model.addAttribute("addMentorTemplateBean", new AddMentorBean());
//
//		return NEW_MENTOR;
//	}
//
//	@RequestMapping(method = RequestMethod.POST, value = NEW_MENTOR)
//	public @ResponseBody
//	Map<String, ? extends Object> addCourseTemplate(
//			@RequestBody AddMentorBean addMentorTemplateBean)
//			throws Exception {
////		Set<ConstraintViolation<AddMentorBean>> failures = validator
////				.validate(addMentorBean);
//		if (!failures.isEmpty()) {
...
//			@RequestBody EditMentorBean editMentorTemplateBean)
//			throws Exception {
...
//	}
//
//	@RequestMapping(method = RequestMethod.GET, value = LIST_MENTOR)
...
//			Set<ConstraintViolation<AddMentorBean>> failures) {
//		Map<String, String> failureMessages = new HashMap<String, String>();
//		for (ConstraintViolation<AddMentorBean> failure : failures) {
...
//			Set<ConstraintViolation<EditMentorBean>> failures) {
//		Map<String, String> failureMessages = new HashMap<String, String>();
//		for (ConstraintViolation<EditMentorBean> failure : failures) {
//			failureMessages.put(failure.getPropertyPath().toString(),
//					failure.getMessage());
//		}
//		return failureMessages;
//	}
//
//	@RequestMapping(value = ASSIGN_MENTOR_EXERCISE, method = RequestMethod.GET)
...
//		model.addAttribute("MENTORTEMPLATESLIST", mentorTemplatesList);
//
//		return ASSIGN_MENTOR_EXERCISE;
//	}
//
//	@RequestMapping(value = MENTOR_EXERCISE_FORM, method = RequestMethod.GET)
...
//
//		return MENTOR_EXERCISE_FORM;
//
//	}
//
//	@RequestMapping(method = RequestMethod.POST, value = MENTOR_EXERCISE_FORM)
//	public @ResponseBody
...
//	}
//
//	@RequestMapping(value = ASSIGN_MENTOR_MENTOR, method = RequestMethod.GET)
...
//
//		return ASSIGN_MENTOR_MENTOR;
//	}
//
//	@RequestMapping(value = MENTOR_MENTOR_FORM, method = RequestMethod.GET)
...
//
//		return MENTOR_MENTOR_FORM;
//
//	}
//
//	@RequestMapping(method = RequestMethod.POST, value = MENTOR_MENTOR_FORM)
//	public @ResponseBody
...
//	}
//
//	@RequestMapping(value = MENTOR_PROFILE, method = RequestMethod.GET)
...
//	}
//
//	@RequestMapping(value = MENTOR_TABBED_EXFORM, method = RequestMethod.GET)
...
//				new AssignMentorTemplateExercisesBean());
//
//		return MENTOR_TABBED_EXFORM;
//
//	}
//
//	@RequestMapping(method = RequestMethod.POST, value = MENTOR_TABBED_EXFORM)
//	public @ResponseBody
...
//	}
//
//	@RequestMapping(value = MENTOR_MENTOR_TABBED, method = RequestMethod.GET)
...
//				new AssignMentorMentorTemplateBean());
//
//		return MENTOR_MENTOR_TABBED;
//
//	}
//
//	@RequestMapping(method = RequestMethod.POST, value = MENTOR_MENTOR_TABBED)
//	public @ResponseBody
