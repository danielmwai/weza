...
<script>
    ...
    <c:if test="${afterRemoveUrl!=null}">
                window.location = '<c:url value="${afterRemoveUrl}" />';</c:if>
    <c:if test="${refreshUrl!=null}">
                    window.location = '<c:url value="${refreshUrl}" />';</c:if>
                        } else {
    ...
    <c:if test="${expandDetails!=null && expandDetails!=''}">
                                    canExpandRecords: true,
                                            ...
                                            detailField: "<c:out value="${expandDetails}"/>",</c:if>
    ...
    <c:if test="${groupByEntity!=null && groupByEntity!=''}">
                                                groupStartOpen:"all",
                                                        groupByField: '<c:out value="${groupByEntity}"/>',</c:if>
                                                                    //autoFetchData: true
    ...
    <c:if test="${appendQueryStringToEdit!=null && appendQueryStringToEdit!=''}">
                                                                            queryString = queryString + '&<c:out value="${appendQueryStringToEdit}" />';</c:if>
