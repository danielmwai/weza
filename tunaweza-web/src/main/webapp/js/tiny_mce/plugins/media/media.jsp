...
<head>
	...
	<script type="text/javascript" src="${PREFIX}/js/tiny_mce/plugins/media/js/media.js"></script>
        <script type="text/javascript" src="${PREFIX}/js/tiny_mce/plugins/media/js/embed.js"></script>
	...
	<link href="${PREFIX}/js/tiny_mce/plugins/media/css/media.css" rel="stylesheet" type="text/css" />
</head> --%>
<title>{#media_dlg.title}</title>
