...
<div id="loading" style="display: none;">
	<p>
		<img src="${PREFIX}/images/splash/loading.gif" /> Please Wait
	</p>
</div>

<div id="newCompany" align="center">
	<!-- <div style="float: center; margin: 5px;">
		<img src="${PREFIX}/images/splash/jjcloud.png" title="jjcloud"
			width="300px" />
	</div>  -->
	<iframe id="regy" name="regy" style="display: none"></iframe>
	<fieldset style="margin: auto; width: 710px">
		<legend>Company Registration</legend>
		<form:form id="addCompanyBean" method="post"
			enctype="multipart/form-data" modelAttribute="addCompanyBean">

			<div id="companyBean_errors" class="error">
			...
			<table border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					<th colspan="2" align="center">Register Company</th>
				</tr>
				<tr>
				...
				<tr>
					<td>Product Name:</td>
					<td><form:textarea path="productName" cols="30" rows="5"
							cssClass="forminput" /></td>
				</tr>
				<tr>
					<td>Company Name: <span style="color: red;">*</span>
					</td>
					<td><form:textarea path="name" cols="30" rows="5"
							cssClass="forminput" /></td>
				</tr>
				<tr>
					<td>Background Color: <span style="color: red;">*</span>
					</td>
					<td><form:input path="bg_color_code"
							cssClass="forminput colorpickers" id="colorpickerField1" /></td>
				</tr>
				<tr>
					<td>Company Color: <span style="color: red;">*</span>
					</td>
					<td><form:input path="header_color_code"
							cssClass="forminput colorpickers" id="colorpickerField2" /></td>
				</tr>
				<tr>
					<td>Menu Font Color: <span style="color: red;">*</span>
					</td>
					<td><form:input path="font_color_code"
							cssClass="forminput colorpickers" id="colorpickerField4" /></td>
				</tr>
				<tr>
					<td>Menu Color: <span style="color: red;">*</span>
					</td>
					<td><form:input path="menu_color_code"
							cssClass="forminput colorpickers" id="colorpickerField3" /></td>
				</tr>

				<tr>
					<td>Company Logo: <span style="color: red;">*</span>
					</td>
				...
				<tr>
					...
					<td><form:input path="email" cssClass="forminput" /></td>
				</tr>
				<tr>
					<td>Password:<span style="color: red;">*</span>
					</td>
					<td valign="top"><form:password path="password"
							cssClass="forminput password_sbar" /></td>
				</tr>
				<tr>
					<td valign="top">Re-enter Password:<span style="color: red;">*</span>
					</td>
					<td valign="top"><form:password path="repassword"
							cssClass="forminput" /></td>
				</tr>
				<tr>
					<td>Company Website: <span style="color: red;">*</span>
					</td>
					<td><form:input path="website" cssClass="forminput" /></td>
				</tr>
				<tr>
					<td>Company Location: <span style="color: red;">*</span>
					</td>
					<td><form:select path="otherLocation" cssClass="forminput"
							...
							<option value="Congo, The Democratic Republic of">Congo,
							...
							<option value="Holy See (Vatican CityState)">Holy See
				...
				<tr>
					<td>Tel Line 1: <span style="color: red;">*</span>
					</td>
					<td><form:input path="firstline" cssClass="forminput" />
				</tr>
				<tr>
					<td>Tel Line 2:</td>
					<td><form:input path="secondline" cssClass="forminput" />
				</tr>
				<tr>
					<td>Address: <span style="color: red;">*</span>
					</td>
					<td><form:textarea cols="30" rows="5" path="address"
							cssClass="forminput" />
				</tr>
				...
				<tr>
					<td colspan=2><button type="submit" class="submit_button">Submit
							details</button> <!-- <input type="submit" value="Submit details" /> --> <a
						href="${PREFIX}/login.htm">Log in instead</a></td>
				</tr>
			</table>
...
<script type="text/javascript">
	// 	function fillinbox() {
	// 		JJTeach.showprogress('Inbox', 'Loading.....',
	// 				'<img src="Images/loadingimage.gif"/>');
	// 		$j.post("controller/messagecontroller.aspx", {
	// 			action : 'inbox',
	// 			page : '1'
	// 		}, function(ret) {
	// 			$("#divResult").html(ret);
	...
	function showRequest(formData, jqForm, options) {
		JJTEACH.showprogress('please wait!',
				'Creating a new instance of jjteach..');
		return true;
	}

	// post-submit callback 
	function showResponse(responseText, statusText, xhr, $form) {
		JJTEACH.hideprogress();
		alert('status: '
				+ statusText
				+ '\n\nresponseText: \n'
				+ responseText
	...
	$j().ready(function() {
		...
		/*	$j("#addCompanyBean").submit(
					function() {
						$j('#companyBean_errors').html(
				...
				.submit(
						function() {
							...
							$j('#register_errors').html(
									"Processing..........");
							$j.postJSON($j('#addCompanyBean').attr(
		...
		/* $('#addCompanyBean').submit(function(e) {
		    e.preventDefault(); // don't submit multiple times
		    this.submit(); // use the native submit method of the form element
		    showLoading(); // blank the input
		}); */
...
<script type="text/javascript">
	$j().ready($('.colorpickers').ColorPicker({
...
<script type="text/javascript">
	$j(function() {
		...
		$j("#location")
				.validate(
						{
							expression : "if ((jQuery('#otherLocation').val() == 'Other' && VAL) || (jQuery('#otherLocation').val() != 'Other')) return true; else return false;",
		...
		$j("#colorpickerField3").validate({
			expression : "if (VAL) return true; else return false;",
			message : "Please enter the Required field",
			error_class : "errors",
			error_field_class : "errors"
		});
		$j("#colorpickerField4").validate({
			expression : "if (VAL) return true; else return false;",
			message : "Please enter the Required field",
			error_class : "errors",
			error_field_class : "errors"
