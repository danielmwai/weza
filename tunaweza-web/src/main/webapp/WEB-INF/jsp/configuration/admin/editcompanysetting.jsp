...
<div id=comanysetting>
	...
	<form:form method="post" modelAttribute="companySettingBean"
		...
		<div class="container">
			...
			<div class="container_inner">
				<label class="title">Company Logo</label> <img id="img" height=80px
					width=240px src="${PREFIX}/companysetting/logo.htm" title="jjteach"
					alt="company logo" /><br>
				<div id="change_logo">
	...
	--%>
		...
		<div class="container">
			...
			<div class="container_inner">
				<label class="title">Menu Color</label> <span style="color: red;">*</span>
		...
		<button type="submit" class="submit_button">Add Settings</button>
		...
		<%-- <table id="table-form-input">
					...
					<tbody>
						...
						<tr>
							<td width="20%" valign="top">Company Logo</td>
							<td>
							<img id = "img" height=80px width=240px src="${PREFIX}/companysetting/logo.htm" 
							title="jjteach" alt ="company logo" /><br>
							<div id="change_logo">
							<span style="color: red;">*</span>
								<form:input path="logo_image" cssClass="forminput" type="file" />
								</div>
						...
						<tr>
							...
							<td width="79%" valign="top"><span style="color: red;">*</span>
								<form:input path="bg_color_code" style="background-color:${BG_COLOR}"
								 cssClass="forminput" id="colorpickerField1" /></td>
						</tr>
						<tr>
							<td width="20%" valign="top">Company Header Color:</td>
							<td width="79%" valign="top"><span style="color: red;">*</span>
								<form:input path="header_color_code" style="background-color:${HEADER_COLOR}"
								 cssClass="forminput" id="colorpickerField2" /></td>
						</tr>
						<tr>
							<td width="20%" valign="top">Enable Mentoring:</td>
							<td width="79%" valign="top"><form:checkbox path="mentoring"
									cssClass="forminput" />
							</td>
						</tr>
