...
<form:form method="post" class="add_form" id="addLocationBean"
	modelAttribute="addLocationBean">

	<div id="addlocation_errors" class="error"></div>

	<div class="container country">
		<div class="container_inner">
			<label class="title">Select Location</label><br />
			...
			<div id="other">
				...
				<form:input path="name" cssClass="forminput" style="display:none" />
			</div>
		</div>
	</div>
	<div class="container description">
		<div class="container_inner">
			...
			<form:textarea cols="30" rows="5" path="description" cssClass="inputtextarea"
				 />
		</div>
	</div>
	...
	<%-- <table id="table-form-input">
		...
		<tbody>
			...
			<tr>
				...
				<a onClick="JJTEACH.ajaxLoad('/location/list'); return false;">Cancel</a>
				</td>
			</tr>
		</tbody>
	</table> --%>
...
<script type="text/javascript">
	$j().ready(
			function() {
				$j("#addLocationBean").submit(
						function() {
							var account = $j(this).serializeObject();
							$j('#addlocation_errors').html(
									"Processing..........");
							$j.postJSON($j('#addLocationBean').attr('action'),
	...
	function doaction(data) {
		var message = data.u;
		$j('#addlocation_errors').html(message);
		if (message == "Saved") {
...
<script type="text/javascript">
	$j(function() {
		...
		$j("#name").validate({
			expression : "if ((jQuery('#location').val() == 'Other' && VAL) || (jQuery('#location').val() != 'Other')) return true; else return false;",
