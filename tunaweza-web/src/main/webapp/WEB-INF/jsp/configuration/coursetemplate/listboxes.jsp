...
<script type="text/javascript">
	$j("#assignCourseTemplateModulesBean").submit(
			function() {
				...
				$j.postJSON($j('#assignCourseTemplateModulesBean').attr(
	...
	function doaction(data) {
		...
		if (message == "Saved") {
			alert(message);
			JJTEACH.ajaxLoad('/coursetemplate/listcoursetemplates');
		}
		else{
			jAlert(message, 'Warning !');
			JJTEACH.ajaxLoadCTModules('/coursetemplate/ctlistboxes', ${TEMPLATEID});
...
<form:form method="post"
	modelAttribute="assignCourseTemplateModulesBean" target="assignctframe">

	<form:hidden path="id" value="${TEMPLATEID}" />
	<form:hidden path="moduleList" id="weqt" />
	...
	<div id="multiselectcontainer">
		...
		<div class="from_container">
			<span class="title"> Unassigned Modules </span><br /> <select
				id="fromSelectBox" multiple="multiple">
				<c:forEach var="module" items="${ALLMODULELIST}" varStatus="status">
		...
		<div class="to_container">
			<span class="title"> Assigned Modules</span> <br /> <select
				id="toSelectBox" multiple="multiple" name="moduleList">
