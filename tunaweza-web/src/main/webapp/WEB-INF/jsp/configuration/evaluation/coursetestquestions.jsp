...
<div class="fieldShadow" style="margin-top: 25px">
	<fieldset>
		<form:form modelAttribute="evaluationTestBean"
			action="${PREFIX}/studenttest/course/administer/test.htm">
			...
			<table class="table-form-input">
				<tbody>
					...
					<tr>
						<td width="20%" valign="top"><b>Course:</b>
						</td>
						<td width="79%" valign="top">${evaluationTestBean.course}</td>
					</tr>
					<tr>
						<td width="20%" valign="top"><b>Question:</b>
						</td>
						<td width="90%" valign="top">
							<div class="question">${evaluationTestBean.questionText}</div></td>
					</tr>
					<tr>
