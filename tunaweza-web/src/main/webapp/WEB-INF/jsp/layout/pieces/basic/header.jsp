...
<link href="${PREFIX}/css/basic.css" rel="stylesheet" type="text/css" />
...
<link href="${PREFIX}/css/header_nav1.css" rel="stylesheet" type="text/css"/>
<link href="${PREFIX}/css/header_nav2.css" rel="stylesheet" type="text/css"/>
...
<%-- <link href="${PREFIX}/css/colorcodes.css" rel="stylesheet" type="text/css" />
<link href="${PREFIX}/css/datePicker.css" rel="stylesheet" type="text/css" /> --%>
