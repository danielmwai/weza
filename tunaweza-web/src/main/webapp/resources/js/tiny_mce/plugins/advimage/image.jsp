...
<head>
	...
	<script type="text/javascript" src="${PREFIX}/js/tiny_mce/utils/mctabs.js"></script>
	<script type="text/javascript" src="${PREFIX}/js/tiny_mce/utils/form_utils.js"></script>
	<script type="text/javascript" src="${PREFIX}/js/tiny_mce/utils/validate.js"></script>
	<script type="text/javascript" src="${PREFIX}/js/tiny_mce/utils/editable_selects.js"></script>
	<script type="text/javascript" src="${PREFIX}/js/tiny_mce/plugins/advimage/js/image.js"></script>
	<script type="text/javascript" src="${PREFIX}/js/tiny_mce/plugins/advimage/js/functions.js"></script>
	<script type="text/javascript" src="${PREFIX}/js/jquery-1.6.2.min.js"></script>
	<link href="${PREFIX}/js/tiny_mce/plugins/advimage/css/advimage.css" rel="stylesheet" type="text/css" />
</head>
<body id="advimage" style="display: none" role="application" aria-labelledby="app_title">
  ...
  <fieldset>
    ...
    <form id='image_upload_form' enctype="multipart/form-data" method="post" onsubmit="ts_onload(); return true;" 
    	target="html_editor_image_upload_frame" >
             <!--   target="html_editor_image_upload_frame" -->

      <input class="input-file" id="image_uploaded_data" name="image" size="30" type="file" />
	...
	<form onsubmit="ImageDialog.insert();return false;" action="#"> 
		<div class="tabs">
			<ul>
				 <li id="dynamic_select_tab" class="current" aria-controls="dynamic_select_panel" ><span><a href="javascript:mcTabs.displayTab('dynamic_select_tab','dynamic_select_panel');" onmousedown="return false;">Uploaded Images</a></span></li>
				<li id="general_tab"  aria-controls="general_panel"><span><a href="javascript:mcTabs.displayTab('general_tab','general_panel');" onmousedown="return false;">{#advimage_dlg.tab_general}</a></span></li>
			...
			<div id="dynamic_select_panel" class="panel current" style='overflow: auto'>
				<fieldset>
					...
					<c:forEach items="${IMAGES}"  var="image">
						<img 
						     src="${SERVERADDRESS}${PREFIX}/js/tiny_mce/plugins/advimage/displayimage.htm?imageId=${image.id}" 
						     onclick="ts_insert_image('${SERVERADDRESS}${PREFIX}/js/tiny_mce/plugins/advimage/displayimage.htm?imageId=${image.id}', 
						'${image.imageText}');" />
					</c:forEach>					
				</fieldset>
			</div>
