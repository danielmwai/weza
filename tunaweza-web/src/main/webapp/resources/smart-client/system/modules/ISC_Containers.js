...
if (window.isc && window.isc.module_Core && !window.isc.module_Containers) {
    ...
    if (isc._moduleEnd && (!isc.Log || (isc.Log && isc.Log.logIsDebugEnabled('loadTime')))) {
        isc._pTM = {message: 'Containers load/parse time: ' + (isc._moduleStart - isc._moduleEnd) + 'ms', category: 'loadTime'};
    ...
    , isc.A.initWidget = function isc_ImgTab_initWidget(_1, _2, _3, _4, _5, _6) {
        if (this.vertical && this.titleStyle)
            this.titleStyle = "v" + this.titleStyle;
    ...
    , isc.A.addTabs = function isc_TabBar_addTabs(_1, _2) {
        if (!_2 && this.tabBarPosition == isc.Canvas.LEFT)
            _2 = 0;
    ...
    , isc.A.$7b = function isc_TabBar__scrollForward(_1, _2) {
        if (this.overflow == isc.Canvas.VISIBLE || !this.members || this.members.length == 0)
            return;
        var _3, _4;
        if (this.$7c != null) {
            ...
            if (_5 <= (this.vertical ? this.getViewportHeight() : this.getViewportWidth()))
                return;
            var _6 = (this.vertical ? this.getScrollTop() : this.getScrollLeft()), _7 = (this.vertical ? this.getViewportHeight() : this.getViewportWidth());
            var _8 = 5;
    ...
    , isc.A.scrollTabIntoView = function isc_TabBar_scrollTabIntoView(_1, _2, _3, _4) {
        ...
        if (_2 == null) {
            if (_5 == 0)
                _2 = true;
            else if (_5 == (this.members.getLength() - 1))
                _2 = false;
            else {
                if (_9) {
                    if (this.getScrollTop() > _6[1])
                        _2 = true;
                    else
                        _2 = false
                } else {
                    if (this.getScrollLeft() > _6[0])
                        _2 = true;
                    else
                        _2 = false
                }
        ...
        if (_5 == 0)
            _6[0] = _6[1] = 0;
        this.scrollIntoView(_6[0], _6[1], _6[2], _6[3], _7, _8, _3, {target: this, methodName: "scrolledTabIntoView", args: [_1, _4]})
    }
    ...
    isc.A.headerLabelDefaults = {wrap: false, align: isc.Canvas.LEFT, styleName: "windowHeaderText", width: 10, inherentWidth: true};
    ...
    isc.A.closeButtonDefaults = {width: 16, height: 14, layoutAlign: "center", src: "[SKIN]/Window/close.gif", click: function() {
            return this.creator.$7e()
        }};
    isc.A.showMinimizeButton = true;
    isc.A.minimizeButtonConstructor = "ImgButton";
    isc.A.minimizeButtonDefaults = {width: 16, height: 14, layoutAlign: "center", src: "[SKIN]/Window/minimize.gif", click: function() {
    ...
    isc.A.restoreButtonDefaults = {width: 16, height: 14, src: "[SKIN]/Window/restore.gif", layoutAlign: "center", click: function() {
    ...
    isc.A.maximizeButtonDefaults = {width: 16, height: 14, src: "[SKIN]/Window/maximize.gif", layoutAlign: "center", click: function() {
    ...
    isc.A.statusBarDefaults = {overflow: isc.Canvas.HIDDEN, styleName: "windowStatusBar", addAsChild: true, width: "100%", wrap: false, leftPadding: 5};
    isc.A.showResizer = true;
    isc.A.resizerConstructor = "Img";
    isc.A.resizerDefaults = {canDragResize: true, getEventEdge: function() {
    ...
    isc.D = isc._funcClasses;
    isc.D[isc.C] = isc.A.Class;
    isc.A.autoChildParentMap = {resizer: "footer", statusBar: "footer", headerBackground: "header", headerIcon: "header", headerLabel: "header", minimizeButton: "header", maximizeButton: "header", closeButton: "header", toolbar: "body"};
    isc.B.push(isc.A.initWidget = function isc_Window_initWidget() {
        ...
        if (!this.$7f && this.items != null) {
            for (var i = 0; i < this.items.length; i++) {
                if (isc.isA.Canvas(this.items[i]) && this.items[i].isDrawn())
                    this.items[i].clear()
            }
        }
    }
    ...
    , isc.A.makeToolbar = function isc_Window_makeToolbar() {
        this.addAutoChild("toolbar", {buttons: this.toolbarButtons, visibility: this.minimized ? isc.Canvas.HIDDEN : isc.Canvas.INHERIT})
    }
    ...
    , isc.A.headerLabel_autoMaker = function isc_Window_headerLabel_autoMaker() {
        ...
        var _1 = isc.Canvas.create({autoDraw: false, _generated: true, contents: isc.Canvas.blankImgHTML(1000, 100), overflow: "hidden"});
        ...
        var _3 = this.headerLabel = this.createAutoChild("headerLabel", {height: "100%", contents: this.title, dragTarget: this, getCurrentCursor: function() {
        ...
        for (var i = 0; i < this.footerControls.length; i++) {
            ...
            if (isc.isA.String(_3)) {
                ...
                if (isc.isA.Canvas(_3))
                    ...
                    isc.addProperties(_3, _4);
                this.footer.addMember(_3)
            }
        }
        this.addAutoChild("statusBar", {height: this.footer.getHeight(), visibility: this.minimized ? isc.Canvas.HIDDEN : isc.Canvas.INHERIT});
        if (this.status != null)
        ...
        if (!this.bodyConstructor) {
            if (_3) {
                ...
                if (!this.bodyProperties)
                    ...
                    isc.addProperties(this.bodyProperties, _6)
            }
        }
    ...
    , isc.A.setBodyColor = function isc_Window_setBodyColor(_1) {
        this.bodyColor = _1;
        if (this.body)
            this.body.setBackgroundColor(_1)
    }
    ...
    , isc.A.addItems = function isc_Window_addItems(_1, _2) {
        ...
        for (var i = 0; i < _1.length; i++) {
            if (!_1[i])
                continue;
            if (this.items.contains(_1[i]))
                continue;
            if (_2 != null)
                this.items.addAt(_1[i], _2 + i);
            else
                this.items.add(_1[i]);
            _1[i].locatorParent = this;
            _1[i].$86x = this.ID;
            if (!this.$7f) {
                if (isc.isA.Canvas(_1[i]) && _1[i].isDrawn())
                    _1[i].clear()
            } else {
    ...
    , isc.A.removeItems = function isc_Window_removeItems(_1) {
        ...
        if (this.$7f) {
            if (this.body.removeMembers)
                this.body.removeMembers(_1);
            else {
                for (var i = 0; i < _1.length; i++) {
                    if (_1[i].parentElement == this.body)
                        _1[i].deparent()
                }
            }
        }
    ...
    , isc.A.locatorChildDestroyed = function isc_Window_locatorChildDestroyed(_1) {
        if (this.items && this.items.contains(_1))
            this.items.remove(_1)
    }
    , isc.A.replaceItem = function isc_Window_replaceItem(_1, _2) {
        if (_1 == _2)
            return _1;
        if (_2 == null)
            return this.removeItem(_1);
        if (_1 == null)
            return this.addItem(_2);
        for (var i = 0; i < this.items.length; i++) {
            if (this.items[i] == _1) {
                this.items[i] = _2;
                if (!this.$7f) {
                    if (isc.isA.Canvas(_2) && _2.isDrawn())
                        _2.clear()
                } else {
                    if (this.body.addMember) {
    ...
    , isc.A.layoutChildren = function isc_Window_layoutChildren(_1, _2, _3, _4) {
        ...
        if (_5)
            _5.setHeight(this.getVisibleHeight(true))
    }
    ...
    , isc.A.setAutoSize = function isc_Window_setAutoSize(_1) {
        ...
        if (_1) {
            if (this.body) {
                if (isc.isA.Layout(this.body))
                    this.body.vPolicy = this.body.hPolicy = "none";
            ...
            if (this.body) {
                if (isc.isA.Layout(this.body))
                    this.body.vPolicy = this.body.hPolicy = "fill";
    ...
    , isc.A.dragResizeStart = function isc_Window_dragResizeStart() {
        if (this.Super("dragResizeStart", arguments) == false)
            return;
        ...
        if (this.isModal) {
            if (this.modalTarget) {
                if (!isc.isA.Canvas(this.modalTarget) || this.modalTarget.contains(this)) {
                    ...
                    this.modalTarget.showComponentMask(this.showModalMask ? {styleName: this.modalMaskStyle, opacity: this.modalMaskOpacity} : null);
    ...
    , isc.A.makeModalMask = function isc_Window_makeModalMask() {
        if (!this.showModalMask)
            return;
        if (!this.modalMask)
            this.modalMask = this.createAutoChild("modalMask", {styleName: this.modalMaskStyle, opacity: this.modalMaskOpacity});
        this.modalMask.show()
    }
    ...
    , isc.A.shouldDismissOnEscape = function isc_Window_shouldDismissOnEscape() {
        if (this.dismissOnEscape != null)
            return this.dismissOnEscape;
    ...
    , isc.A.handleMoved = function isc_Window_handleMoved() {
        ...
        if (this.isDrawn() && !this.$7j)
            this.autoCenter = false
    }
    , isc.A.centerInPage = function isc_Window_centerInPage() {
        var _1 = this.getVisibleWidth(), _2 = this.getVisibleHeight(), _3 = this.parentElement ? this.parentElement : isc.Page, _4 = ((_3.getWidth() - _1) / 2) + _3.getScrollLeft(), _5 = ((_3.getHeight() - _2) / 2) + _3.getScrollTop();
        _4 = Math.round(_4);
    ...
    , isc.A.flash = function isc_Window_flash(_1) {
        ...
        if (_2) {
            var _3 = (_1 % 2 == 0 ? this.hiliteHeaderStyle : this.$7m), _4 = (_1 % 2 == 0 ? this.hiliteHeaderSrc : this.$7o), _5 = (_1 % 2 == 0 ? this.hiliteHeaderStyle : this.$7n);
    ...
    , isc.A.animateMinimizeStep = function isc_Window_animateMinimizeStep(_1, _2, _3, _4, _5) {
        ...
        var _7 = this.minimized ? this.$7v : this.maximized ? this.$42v : this.$7r, _8 = _4 ? this.$7r : _5 ? this.$42v : this.$7v, _9 = this.maximized ? this.$42w : this.$42x, _10 = _5 ? this.$42w : this.$42x;
        ...
        var _13 = _11 - this.getVMarginBorder() - (2 * this.layoutMargin) -
                (this.showHeader ? this.header.getHeight() + this.membersMargin : 0), _14 = (this.showBody ? this.body : null), _15 = (this.showFooter ? this.footer : null), _16 = 0, _17 = 0, _18 = (_15 ? this.footerHeight : 0), _19 = this.membersMargin || 0;
        if (_15 != null) {
            if (_13 <= _18) {
                _16 = _13
            } else {
        ...
        if (_5 || this.maximized) {
            var _22 = (_5 ? this.$42y : 0), _23 = (_5 ? this.$42z : 0), _24 = (_5 ? 0 : this.$42y), _25 = (_5 ? 0 : this.$42z);
        ...
        if (_1 == 1) {
            ...
            delete this.$7k
            if (_4)
                this.completeRestore(true);
            else if (_5)
                this.completeMaximize(true);
            else
                this.completeMinimize(this.$7v, true)
        }
    }
    ...
    , isc.A.isAnimating = function isc_Window_isAnimating(_1, _2, _3, _4, _5) {
        if (this.invokeSuper(isc.Window, "isAnimating", _1, _2, _3, _4, _5))
            return true;
        if (_1 && !isc.isAn.Array(_1))
            _1 = [_1];
        if (this.$7k && ((_1 == null) || (_1.contains("minimize")) || (_1.contains("rect"))))
            return true;
        return false
    }
    , isc.A.completeMinimize = function isc_Window_completeMinimize(_1, _2) {
        this.minimized = true;
        this.maximized = false;
        if (this.body && this.body.isVisible())
            this.body.hide();
        ...
        if (this.$420 != null) {
            if (!_2)
                this.setWidth(this.$420);
            this.$pn = this.$420
        }
        if (!_2) {
            this.setHeight(_1);
            if (this.$42y != null)
                this.setLeft(this.$42y);
            if (this.$42z != null)
                this.setTop(this.$42z)
        }
        if (this.$421 != null)
            this.setShowShadow(this.$421);
    ...
    , isc.A.completeRestore = function isc_Window_completeRestore(_1) {
        if (this.$7u != null)
            this.setOverflow(this.$7u);
        if (this.$7q != null)
            this.setHeight(this.$7q);
        if (this.$420 != null)
            this.setWidth(this.$420);
        if (!_1) {
            if (this.$42y != null)
    ...
    , isc.A.setMinWidth = function isc_Portlet_setMinWidth(_1) {
        ...
        this.minWidth = _1;
        if (this.portalRow)
            this.portalRow.reflow("Portlet minWidth changed")
    }
    , isc.A.setRowHeight = function isc_Portlet_setRowHeight(_1) {
        this.rowHeight = _1;
        if (this.portalRow)
            this.portalRow.setHeight(_1)
    }
    ...
    , isc.A.maximize = function isc_Portlet_maximize() {
        var _1 = this.getVisibleWidth(), _2 = this.getVisibleHeight(), _3 = this.getPageLeft(), _4 = this.getPageTop();
        this.$55d = isc.Canvas.create({width: this.getVisibleWidth(), height: this.getVisibleHeight(), minHeight: this.getMinHeight(), minWidth: this.getMinWidth(), $858: this});
    ...
    isc.B.push(isc.A.initWidget = function isc_PortalColumnHeader_initWidget() {
        ...
        this.menu = this.getMenuConstructor().create({width: 150, portalColumn: this.creator, data: [{title: "Remove Column", click: "menu.portalColumn.removeSelf()", enableIf: function(_1, _2, _3) {
    ...
    isc.B.push(isc.A.initWidget = function isc_PortalRow_initWidget() {
        this.Super("initWidget", arguments);
        if (this.portlets)
            this.addPortlets(this.portlets);
        this.portlets = null
    }
    ...
    , isc.A.isPortalColumnDrop = function isc_PortalRow_isPortalColumnDrop() {
        ...
        if (_1.isA("Palette")) {
            ...
            if (_4.className == "PortalColumn" || _4.type == "PortalColumn")
                return true
        }
        return false
    }
    ...
    , isc.A.getDropComponent = function isc_PortalRow_getDropComponent(_1, _2) {
        ...
        if (this.handleDroppedEditNode)
            _3 = this.handleDroppedEditNode(_3, _2);
        if (_3) {
    ...
    , isc.A.initWidget = function isc_PortalColumn_initWidget() {
        ...
        if (this.portalRows)
            this.addPortalRows(this.portalRows);
    ...
    , isc.A.$87y = function isc_PortalColumn__getDesiredWidth() {
        ...
        if (_1.length == 0) {
            ...
            if (this.rowLayout.vscrollOn)
                _2 += this.rowLayout.getScrollbarSize();
    ...
    , isc.A.setPreventColumnUnderflow = function isc_PortalLayout_setPreventColumnUnderflow(_1) {
        if (this.preventColumnUnderflow == _1)
            return;
    ...
    , isc.A.setPreventRowUnderflow = function isc_PortalLayout_setPreventRowUnderflow(_1) {
        if (this.preventRowUnderflow == _1)
            return;
    ...
    , isc.A.initWidget = function isc_PortalLayout_initWidget() {
        ...
        if (this.canResizeRows != null)
            this.setCanResizePortlets(this.canResizeRows);
        if (this.portalColumns) {
            this.addPortalColumns(this.portalColumns);
            delete this.portalColumns
        } else if (this.portlets) {
            var _1 = this;
            if (!isc.isAn.Array(this.portlets))
                this.portlets = [this.portlets];
            if (!isc.isAn.Array(this.portlets[0]))
                this.portlets = [this.portlets];
    ...
    , isc.A.removePortlet = function isc_PortalLayout_removePortlet(_1) {
        if (this.editContext && _1.editNode) {
            ...
            if (_1.portalRow)
                _1.portalRow.removePortlets(_1)
        }
    }
    );
    ...
    isc.A.bodyDefaults = isc.addProperties({}, isc.Window.getInstanceProperty("bodyDefaults"), {layoutTopMargin: 15, layoutLeftMargin: 15, layoutRightMargin: 15, layoutBottomMargin: 5});
    ...
    isc.A.autoChildParentMap = isc.addProperties({}, isc.Window.getInstanceProperty("autoChildParentMap"), {messageStack: "body", messageIcon: "messageStack", messageLabel: "messageStack"});
    ...
    isc.A.toolbarDefaults = isc.addProperties({}, isc.Window.getInstanceProperty("toolbarDefaults"), {layoutAlign: "center", width: 20, click: function(_1, _2) {
    ...
    isc.Dialog.changeDefaults("toolbarDefaults", {makeButton: function(_1) {
    ...
    isc.Dialog.Prompt = {ID: "isc_globalPrompt", _generated: true, width: 400, height: 90, autoDraw: false, autoSize: true, isModal: true, showHeader: false, showFooter: false, showToolbar: false, dismissOnEscape: false, bodyStyle: "promptBody", bodyDefaults: isc.addProperties({}, isc.Dialog.getInstanceProperty("bodyDefaults"), {height: "100%"}), message: "Loading...&nbsp;${loadingImage}", messageStackDefaults: isc.addProperties({}, isc.Dialog.getInstanceProperty("messageStackDefaults"), {height: "100%", width: "100%", layoutAlign: "center"}), messageLabelDefaults: isc.addProperties({}, isc.Dialog.getInstanceProperty("messageLabelDefaults"), {width: "100%", align: isc.Canvas.CENTER, valign: isc.Canvas.CENTER}), layoutMargin: 0, showMessage: function(_1, _2) {
        ...
        }, fadeDuration: 2000, fadeMessage: function() {
            delete this.pendingFade;
    ...
    isc.addGlobal("clearPrompt", function() {
        if (!isc.isA.Dialog(isc.Dialog.Prompt))
            return;
    ...
    isc.Dialog.Warn = {ID: "isc_globalWarn", _generated: true, width: 360, height: 60, isModal: true, canDragReposition: true, keepInParentRect: true, autoDraw: false, autoSize: true, autoCenter: true, buttons: [isc.Dialog.OK], message: "Your message here!", showMessage: function(_1, _2) {
            if (_1 == null)
                _1 = "&nbsp;";
            this.message = _1;
            if (!this.icon && _2.icon)
                this.icon = _2.icon;
            this.setProperties(_2);
            if (_2.callback == null)
            ...
            if (this.icon) {
                ...
                this.messageIcon.hide();
            this.toolbar.layoutChildren();
            if (this.messageLabel.isDirty())
    ...
    isc.addGlobal("showMessage", function(_1, _2, _3, _4) {
        ...
        if (!_4.title) {
            if (_2 == "confirm")
                _4.title = isc.Dialog.CONFIRM_TITLE;
            else if (_2 == "ask")
                _4.title = isc.Dialog.ASK_TITLE;
            else if (_2 == "warn")
                _4.title = isc.Dialog.WARN_TITLE;
            else
                _4.title = isc.Dialog.SAY_TITLE
        }
        isc.$78(_4);
        if (!_4.icon)
            _4.icon = isc.Dialog.getInstanceProperty(_2 + "Icon");
        if (_3)
            _4.callback = _3;
    ...
    isc.askForValue = function(_1, _2, _3) {
        ...
        if (!_4) {
            var _5 = isc.DynamicForm.create({numCols: 1, padding: 3, items: [{name: "message", type: "blurb"}, {name: "value", showTitle: false, width: "*"}], saveOnEnter: true, submit: function() {
                    this.askDialog.okClick()
                }});
            _4 = isc.Dialog.Ask = isc.Dialog.create({items: [_5], askForm: _5, canDragReposition: true, isModal: true, bodyProperties: {overflow: "visible"}, overflow: "visible"});
            _5.askDialog = _4;
            _4.$8a = function() {
                this.clear();
        ...
        _3 = isc.addProperties({callback: _2, title: _3.title || isc.Dialog.ASK_FOR_VALUE_TITLE, autoCenter: !_6, left: (_6 ? _3.left || "10%" : null), top: (_6 ? _3.top || "20%" : null), width: _3.width || "80%", height: _3.height || 20, buttons: _3.buttons || [isc.Dialog.OK, isc.Dialog.CANCEL], okClick: _3.okClick || _4.$8a}, _3);
        isc.$78(_3);
        _4.setProperties(_3);
    ...
    isc.A.loginFormDefaults = {numCols: 2, padding: 4, autoDraw: false, saveOnEnter: true, submit: function() {
            ...
            if (_1) {
                ...
                if (_2)
                    window.location.replace(_2)
            }
        }};
    isc.A.formDSDefaults = {clientOnly: true, useAllDataSourceFields: true};
    isc.A.formDefaultFields = [{name: "loginFailureItem", type: "blurb", colSpan: 2, visible: false}, {name: "usernameItem", required: true, browserSpellCheck: false, browserAutoCorrect: false, browserAutoCapitalize: false, keyPress: function(_1, _2, _3) {
                if (_3 == "Enter") {
                    _2.focusInItem("passwordItem");
                    return false
                }
            }}, {name: "passwordItem", type: "password", required: true}, {name: "loginButton", type: "button", type:"submit"}, {name: "lostPasswordItem", type: "link", target: "javascript", canEdit: false, endRow: true, numCols: 2, colSpan: 2, showTitle: false, click: "form.loginDialog.lostPassword(form.getValues(), form)"}, {name: "registrationItem", type: "link", target: "javascript", canEdit: false, endRow: true, numCols: 2, colSpan: 2, showTitle: false, click: "form.loginDialog.register(form.getValues(), form)"}];
    isc.B.push(isc.A.getDynamicDefaults = function isc_LoginDialog_getDynamicDefaults(_1) {
        switch (_1) {
            case"loginForm":
                var _2 = {loginDialog: this, values: {usernameItem: this.username || "", passwordItem: this.password || "", loginFailureItem: this.errorMessage}, fields: this.formFields};
    ...
    , isc.A.init = function isc_LoginDialog_init() {
        if (isc.LoginDialog.firstTimeInit) {
            ...
            isc.LoginDialog.addProperties({title: isc.Dialog.LOGIN_TITLE, usernameItemTitle: isc.Dialog.USERNAME_TITLE, passwordItemTitle: isc.Dialog.PASSWORD_TITLE, loginButtonTitle: isc.Dialog.LOGIN_BUTTON_TITLE, errorMessage: isc.Dialog.LOGIN_ERROR_MESSAGE})
        }
        this.dismissOnEscape = this.showCloseButton = this.dismissable;
        this.Super("init", arguments);
        this.loginForm.focusInItem("usernameItem");
        if (this.username)
            this.loginForm.setValue("usernameItem", this.username);
        if (this.password)
            this.loginForm.setValue("passwordItem", this.password)
    }
    );
    isc.B._maxIndex = isc.C + 3;
    ...
    isc.A.topLayoutDefaults = {_constructor: "HLayout", overflow: "visible", height: 22, align: "left", membersMargin: 5, extraSpace: 5};
    isc.A.addLevelButtonDefaults = {_constructor: "IButton", icon: "[SKINIMG]actions/add.png", autoFit: true, height: 22, showDisabled: false, autoParent: "topLayout", click: "this.creator.addLevel()"};
    isc.A.deleteLevelButtonDefaults = {_constructor: "IButton", icon: "[SKINIMG]actions/remove.png", autoFit: true, height: 22, showDisabled: false, autoParent: "topLayout", click: "this.creator.deleteSelectedLevel()"};
    isc.A.copyLevelButtonDefaults = {_constructor: "IButton", icon: "[SKINIMG]RichTextEditor/copy.png", autoFit: true, height: 22, showDisabled: false, autoParent: "topLayout", click: "this.creator.copySelectedLevel()"};
    isc.A.levelUpButtonTitle = "Move Level Up";
    isc.A.levelUpButtonDefaults = {_constructor: "ImgButton", src: "[SKINIMG]common/arrow_up.gif", height: 22, width: 20, imageType: "center", showDisabled: false, showRollOver: false, showDown: false, showFocused: false, autoParent: "topLayout", click: "this.creator.moveSelectedLevelUp()"};
    isc.A.levelDownButtonTitle = "Move Level Down";
    isc.A.levelDownButtonDefaults = {_constructor: "ImgButton", src: "[SKINIMG]common/arrow_down.gif", height: 22, width: 20, imageType: "center", showDisabled: false, showRollOver: false, showDown: false, showFocused: false, autoParent: "topLayout", click: "this.creator.moveSelectedLevelDown()"};
    isc.A.optionsGridDefaults = {_constructor: "ListGrid", width: "100%", height: "*", canSort: false, canReorderFields: false, canResizeFields: false, canEdit: true, canEditNew: true, selectionType: "single", selectionProperty: "$73s", fields: [{name: "sortSequence", title: "&nbsp;", showTitle: false, canEdit: false, width: 80, canHide: false, showHeaderContextMenuButton: false, formatCellValue: function(_1, _2, _3, _4, _5) {
                    return _3 == 0 ? _5.creator.firstSortLevelTitle : _5.creator.otherSortLevelTitle
                }}, {name: "property", title: " ", type: "select", defaultToFirstOption: true, showHeaderContextMenuButton: false, changed: "item.grid.creator.fireChangeEvent()"}, {name: "direction", title: " ", type: "select", showHeaderContextMenuButton: false, defaultToFirstOption: true, changed: "item.grid.creator.fireChangeEvent()"}], recordClick: function(_1, _2, _3) {
            this.creator.setButtonStates()
        }, bodyKeyPress: function(_1) {
            if (_1.keyName == "Delete" && this.anySelected())
    ...
    , isc.A.getSort = function isc_MultiSortPanel_getSort() {
        ...
        if (_4)
            _2[_3] = isc.addProperties(_2[_3], _4);
    ...
    , isc.A.validate = function isc_MultiSortPanel_validate() {
        ...
        for (var i = 0; i < _2.length; i++) {
            ...
            if (_3.contains(_5.property)) {
                var _6 = this, _7 = this.optionsGrid.getField("property").valueMap[_5.property], _8 = this.invalidListPrompt.evalDynamicString(this, {title: _7});
    ...
    , isc.A.recordFailedValidation = function isc_MultiSortPanel_recordFailedValidation(_1) {
        var _2 = this.optionsGrid, _3 = (isc.isA.Number(_1) ? _1 : _2.getRecordIndex(_1)), _1 = (!isc.isA.Number(_1) ? _1 : _2.data.get(_1));
        _2.selectSingleRecord(_1);
        _2.startEditing(_3, 1)
    }
    , isc.A.getSortSpecifier = function isc_MultiSortPanel_getSortSpecifier(_1) {
        if (isc.isA.Number(_1))
            _1 = this.optionsGrid.data.get(_1);
    ...
    , isc.A.initWidget = function isc_MultiSortPanel_initWidget() {
        ...
        if (this.initialSort)
            this.setSortSpecifiers(this.initialSort);
        else
            this.addLevel()
    }
    , isc.A.setButtonTitles = function isc_MultiSortPanel_setButtonTitles(_1) {
        ...
        if (this.deleteLevelButton)
            this.deleteLevelButton.setTitle(this.deleteLevelButtonTitle);
        if (this.copyLevelButton)
            this.copyLevelButton.setTitle(this.copyLevelButtonTitle)
    }
    , isc.A.setButtonStates = function isc_MultiSortPanel_setButtonStates() {
        var _1 = this.getNumLevels(), _2 = this.maxLevels, _3 = this.optionsGrid, _4 = _3.anySelected(), _5 = _3.getRecordIndex(_3.getSelectedRecord());
        if (this.addLevelButton)
            this.addLevelButton.setDisabled(_1 >= _2);
        if (this.deleteLevelButton)
            this.deleteLevelButton.setDisabled(!_4);
        if (this.copyLevelButton)
            this.copyLevelButton.setDisabled(!_4 || _1 >= _2);
        if (this.levelUpButton)
            this.levelUpButton.setDisabled(!_4 || _5 == 0);
        if (this.levelDownButton)
            this.levelDownButton.setDisabled(!_4 || _5 == _1 - 1)
    }
    , isc.A.setFields = function isc_MultiSortPanel_setFields(_1) {
        if (isc.DataSource && isc.isA.DataSource(_1))
            _1 = isc.getValues(_1.getFields());
        this.fields = _1;
        this.setSortFields();
    ...
    , isc.A.setSortFields = function isc_MultiSortPanel_setSortFields() {
        ...
        this.fields = _1;
        var _4 = this.optionsGrid, _5 = this.fields ? this.fields.getValueMap(_4.fieldIdProperty, "title") : {none: "No fields"}, _6 = isc.getKeys(_5).length;
        for (var _7 in _5) {
    ...
    , isc.A.setSortDirections = function isc_MultiSortPanel_setSortDirections() {
        ...
        this.optionsGrid.getField("direction").valueMap = {"ascending": this.ascendingTitle, "descending": this.descendingTitle}
    }
    , isc.A.addLevel = function isc_MultiSortPanel_addLevel() {
        var _1 = this.optionsGrid, _2 = _1.getRecordIndex(_1.getSelectedRecord()), _3 = _1.getField("property"), _4 = _1.getField("direction"), _5 = _2 >= 0 ? _2 + 1 : _1.data.length, _6 = {property: isc.firstKey(_3.valueMap), direction: isc.firstKey(_4.valueMap)};
        _1.data.addAt(_6, _5);
        this.editRecord(_5);
        this.setButtonStates();
    ...
    , isc.A.copySelectedLevel = function isc_MultiSortPanel_copySelectedLevel() {
        var _1 = this.optionsGrid, _2 = _1.getRecordIndex(_1.getSelectedRecord()), _3 = isc.shallowClone(_1.getRecord(_2));
        if (_2 >= 0) {
    ...
    isc.A.multiSortPanelDefaults = {_constructor: "MultiSortPanel", width: "100%", height: "*", autoParent: "mainLayout"};
    isc.A.title = "Sort";
    isc.A.applyButtonTitle = "Apply";
    isc.A.cancelButtonTitle = "Cancel";
    isc.A.bottomLayoutDefaults = {_constructor: "HLayout", width: "100%", height: 22, align: "right", membersMargin: 5, autoParent: "mainLayout"};
    isc.A.applyButtonDefaults = {_constructor: "IButton", autoFit: true, height: 22, autoParent: "bottomLayout", click: "this.creator.apply()"};
    isc.A.cancelButtonDefaults = {_constructor: "IButton", autoFit: true, height: 22, autoParent: "bottomLayout", click: "this.creator.cancel()"};
    ...
    , isc.A.apply = function isc_MultiSortDialog_apply() {
        if (this.optionsGrid.getEditRow() != null)
            this.optionsGrid.endEditing();
        if (!this.validate())
            return;
        if (this.callback) {
    ...
    isc.A.moreTabPaneDefaults = {_constructor: "VLayout", width: "100%", height: "100%", setData: function(_1) {
            this.creator.moreTabPaneTable.setData(_1)
        }};
    isc.A.moreTabPaneNavBarDefaults = {_constructor: "NavigationBar", controls: ["titleLabel"], autoParent: "moreTabPane"};
    isc.A.moreTabPaneTableDefaults = {_constructor: "TableView", width: "100%", height: "100%", recordNavigationClick: function(_1) {
    ...
    isc.B.push(isc.A.setPaneContainerOverflow = function isc_TabSet_setPaneContainerOverflow(_1) {
        ...
        if (this.paneContainer)
            this.paneContainer.setOverflow(_1)
    }
    );
    isc.B._maxIndex = isc.C + 1;
    ...
    isc.A.$538 = {top: "topEdgeOffsets", bottom: "bottomEdgeOffsets", left: "leftEdgeOffsets", right: "rightEdgeOffsets"};
    ...
    isc.B.push(isc.A.initWidget = function isc_TabSet_initWidget() {
        ...
        if (this.useSimpleTabs) {
            ...
            if (!_2)
                this.tabProperties.autoFit = true;
            if (_2)
                this.tabProperties.autoFitDirection = isc.Canvas.VERTICAL;
            else
                this.tabProperties.autoFitDirection = isc.Canvas.HORIZONTAL;
    ...
    , isc.A.makeTabBar = function isc_TabSet_makeTabBar() {
        ...
        var _7 = isc.addProperties({selectTabOnContextClick: this.selectTabOnContextClick, ID: this.getID() + "_tabBar", width: (_1 ? this.tabBarThickness : "100%"), height: (_1 ? "100%" : this.tabBarThickness), accessKey: this.accessKey, tabIndex: this.tabIndex, tabs: _3, align: this.tabBarAlign, vertical: _1 ? true : false, selectedTab: this.selectedTab, showMoreTab: this.showMoreTab, moreTabCount: this.moreTabCount, moreTab: this.createMoreTab(), allowButtonReselect: this.showMoreTab ? true : false, buttonSelected: function(_11) {
                ...
                if (this.getButtons().contains(_8)) {
                    ...
                    if (_9.showTabContextMenu(_9, _10) == false)
                        return false
                }
                return this.Super("showContextMenu", arguments)
            }, tabBarPosition: this.tabBarPosition, tabBarAlign: this.tabBarAlign, autoDraw: false}, this.tabBarDefaults, this.tabBarProperties);
        _7.creator = this;
    ...
    , isc.A.createMoreTab = function isc_TabSet_createMoreTab() {
        ...
        var _1 = isc.addProperties({title: this.moreTabTitle, icon: this.moreTabImage, pane: this.moreTabPane, moreTab: true}, this.moreTabDefaults, this.moreTabProperties);
        var _2;
        for (var j in this.tabProperties) {
            if (_1[j] === _2)
                _1[j] = this.tabProperties[j]
        }
        this.moreTab = _1;
        return _1
    }
    ...
    , isc.A.makePaneContainer = function isc_TabSet_makePaneContainer() {
        var _1 = {ID: this.getID() + "_paneContainer", _generated: false, className: this.paneContainerClassName, layoutMargin: (this.paneMargin || 0), overflow: this.paneContainerOverflow, $wn: function() {
                var _2 = this.Super("$wn", arguments);
                _2.addMethods({$539: {top: "_top", left: "_left", bottom: "_bottom", right: "_right"}, getEdgePrefix: function(_7) {
        ...
        if (this.showPaneContainerEdges != null)
            _1.showEdges = this.showPaneContainerEdges;
        ...
        if (!this.symmetricEdges) {
            ...
            if (_5 && _5.defaultSize != null)
                _1.edgeSize = _5.defaultSize;
            if (_5 && _5.bottom != null)
                _1.edgeBottom = _5.bottom;
            if (_5 && _5.top != null)
                _1.edgeTop = _5.top;
            if (_5 && _5.left != null)
                _1.edgeLeft = _5.left;
            if (_5 && _5.right != null)
                _1.edgeRight = _5.right;
            var _6 = this[this.$538[this.tabBarPosition]];
            if (_6 && _6.defaultSize != null)
                _1.edgeOffset = _6.defaultSize;
            if (_6 && _6.bottom != null)
                _1.edgeOffsetBottom = _6.bottom;
            if (_6 && _6.top != null)
                _1.edgeOffsetTop = _6.top;
            if (_6 && _6.left != null)
                _1.edgeOffsetLeft = _6.left;
            if (_6 && _6.right != null)
                _1.edgeOffsetRight = _6.right
        }
    ...
    , isc.A.getPaneContainerEdges = function isc_TabSet_getPaneContainerEdges() {
        if (this.showPartialEdges) {
            if (this.tabBarPosition == "bottom")
                return["T", "L", "R"];
            else if (this.tabBarPosition == "left")
                return["T", "B", "R"];
            else if (this.tabBarPosition == "right")
                return["T", "B", "L"];
            else
                return["B", "L", "R"]
        }
    ...
    , isc.A.draw = function isc_TabSet_draw(_1, _2, _3, _4) {
        if (this.tabs && this.tabs.length > 0) {
            ...
            if (!isc.isA.Number(_5) || _5 < 0)
                _5 = this.selectedTab = 0;
    ...
    , isc.A.addTabs = function isc_TabSet_addTabs(_1, _2) {
        ...
        if (_2 == null || _2 > this.tabs.length)
            _2 = this.tabs.length;
        for (var i = 0; i < _1.length; i++) {
    ...
    , isc.A.removeTabs = function isc_TabSet_removeTabs(_1, _2) {
        ...
        if (_3 && this.tabs.length > 0) {
            if (_5 >= this.tabs.length)
                _5 = this.tabs.length - 1;
            this.selectTab(_5)
        }
        this.resetTabPickerMenu();
    ...
    , isc.A.tabIconClick = function isc_TabSet_tabIconClick(_1) {
        var _2 = _1.icon;
        if (_2 && _2.click)
            return this.fireCallback(_2.click, 'tab,tabSet', [_1, this])
    }
    ...
    , isc.A.getTab = function isc_TabSet_getTab(_1) {
        if (isc.isAn.Canvas(_1))
            return _1;
        if (!this.tabs)
            return null;
        if (this.tabs.contains(_1))
            _1 = this.tabs.indexOf(_1);
    ...
    , isc.A.getTabNumber = function isc_TabSet_getTabNumber(_1) {
        ...
        if (isc.isA.String(_1))
            return this.tabs.findIndex("ID", _1);
    ...
    , isc.A.updateTab = function isc_TabSet_updateTab(_1, _2) {
        ...
        if (this.getSelectedTabNumber() == _3) {
            if (!this.paneContainer.hasMember(_2))
                this.paneContainer.addMember(_2);
    ...
    , isc.A.fixLayout = function isc_TabSet_fixLayout() {
        ...
        if (_1 == null || _2 == null)
            return;
        if (_2.getZIndex(true) >= _1.getZIndex(true))
            _2.moveBelow(_1);
        ...
        if (_5) {
            if (_4)
                _1.setHeight(this.getViewportHeight() - this.tabBarControlLayout.getHeight());
            else
                _1.setWidth(this.getViewportWidth() - this.tabBarControlLayout.getWidth());
        ...
        var _6 = this.$8f();
        if (_4) {
            if (_1.getScrollTop() > 0 && _6 <= _1.getViewportHeight())
                _1.scrollTo(null, 0, "descrollTabs")
        } else {
            if (_1.getScrollLeft() > 0 && _6 <= _1.getViewportWidth())
                _1.scrollTo(0, null, "descrollTabs")
        }
    }
    , isc.A.shouldShowControl = function isc_TabSet_shouldShowControl(_1) {
        if ((_1 == "tabScroller") || (_1 == "tabPicker")) {
            if (this.showMoreTab)
                return false;
            if (!this.showTabScroller && _1 == "tabScroller")
                return false;
            if (!this.showTabPicker && _1 == "tabPicker")
                return false;
            var _2 = this.$8f();
            if (_2 == 0)
                return;
            ...
            for (var i = 0; i < this.tabBarControls.length; i++) {
                ...
                if (_5 == "tabScroller" || _5 == "tabPicker")
                    continue;
                if (this.shouldShowControl(_5)) {
                    if (!isc.isA.Canvas(_5))
                        _5 = this.getControl(_5);
                    _3 += _6 ? _5.getVisibleHeight() : _5.getVisibleWidth()
                }
            }
            var _6 = (this._tabBar.orientation == isc.Layout.VERTICAL), _7 = (_2 > (_6 ? (this.getViewportHeight() - _3) : (this.getViewportWidth() - _3)));
            return _7
        }
        var _1 = this.getControl(_1);
        if (isc.isA.Canvas(_1)) {
            if (_1.showIf)
                return _1.fireCallback(_1.showIf, [_1]);
            else
                return true
        }
    }
    ...
    , isc.A.getControl = function isc_TabSet_getControl(_1) {
        ...
        if (_1 == "tabScroller") {
            if (!this.scroller) {
                ...
                var _5 = this.symmetricScroller ? "back" : this.tabBarPosition + "_back", _6 = this.symmetricScroller ? "forward" : this.tabBarPosition + "_forward";
                this.scroller = isc.StretchImgButton.create({noDoubleClicks: true, tabSet: this, vertical: _2, width: _2 ? (this.tabBarThickness - this._tabBar.baseLineThickness) : (2 * _3), height: _2 ? (2 * _3) : (this.tabBarThickness - this._tabBar.baseLineThickness), items: [{name: _5, width: _2 ? null : _3, height: _2 ? _3 : null}, {name: _6, width: _2 ? null : _3, height: _2 ? _3 : null}], skinImgDir: this.skinImgDir, src: _4, showRollOver: false, showDown: false, backPartName: _5, forwardPartName: _6, mouseMove: function() {
                        if (!this.tabSet.showScrollerRollOver)
                            return;
                        ...
                        if (_9)
                            this.tabSet.scrollBack();
                        else
                            this.tabSet.scrollForward();
                        return false
            ...
            if (!this.tabPicker) {
                ...
                this.tabPicker = isc.ImgButton.create({customState: this.symmetricPickerButton ? null : this.tabBarPosition, tabSet: this, showRollOver: false, skinImgDir: this.skinImgDir, src: _11, height: (_2 ? _10 : (this.tabBarThickness - this._tabBar.baseLineThickness)), width: (_2 ? (this.tabBarThickness - this._tabBar.baseLineThickness) : _10), click: function() {
                        this.tabSet.showTabPickerMenu()
                    }}, this.tabPickerProperties)
            }
            return this.tabPicker
        }
        if (isc.isA.String(_1) && isc.isA.Canvas(window[_1]))
            return window[_1];
    ...
    , isc.A.showControls = function isc_TabSet_showControls() {
        var _1 = this.tabBarControls, _2 = 0, _3 = this.tabBarPosition, _4 = _3 == isc.Canvas.RIGHT || _3 == isc.Canvas.LEFT, _5 = 0;
        for (var i = 0; i < _1.length; i++) {
            var _7 = _1[i];
            if (!this.shouldShowControl(_7))
                continue;
            ...
            if (!_8) {
                this.tabBarControlLayout = _8 = this.createAutoChild("tabBarControlLayout", {styleName: this.tabBarControlLayoutDefaults.styleName || this.tabBar.styleName, childResized: function() {
                        this.Super("childResized", arguments);
                        this.creator.$510()
                    }, vertical: _4, locatorParent: this})
            }
        ...
        if (!this.$8g) {
            ...
            this.$8g = this._tabBar.createAutoChild("baseLine", {vertical: (_3 == isc.Canvas.LEFT || _3 == isc.Canvas.RIGHT), _generated: true, skinImgDir: _10.skinImgDir, src: _10.baseLineSrc, capSize: _10.baseLineCapSize, imageType: isc.Img.STRETCH, overflow: "hidden", autoDraw: false});
        ...
        if (!this.$8g.isVisible())
            this.$8g.show();
        return true
    }
    , isc.A.placeControlLayout = function isc_TabSet_placeControlLayout(_1) {
        var _2, _3, _4, _5, _6 = this._tabBar, _7 = _6.getBreadth() - _6.baseLineThickness, _8 = this.tabBarPosition;
        ...
        if (!this.children.contains(this.tabBarControlLayout))
            this.addChild(this.tabBarControlLayout)
    }
    , isc.A.$510 = function isc_TabSet__controlLayoutChildResized() {
        var _1 = this.tabBarControlLayout;
        if (!_1 || !_1.isDrawn() || !_1.isVisible())
            return;
        var _2 = 0;
        for (var i = 0; i < _1.members.length; i++) {
            if (_1.vertical)
                _2 += _1.members[i].getVisibleHeight();
            else
                _2 += _1.members[i].getVisibleWidth()
        }
        this.placeControlLayout(_2);
        var _4 = this.tabBar;
        if (_4) {
    ...
    , isc.A.hideControls = function isc_TabSet_hideControls() {
        if (this.tabBarControlLayout && this.tabBarControlLayout.isVisible())
            this.tabBarControlLayout.hide();
        if (this.$8g && this.$8g.isVisible())
            this.$8g.hide()
    }
    ...
    , isc.A.showTabPickerMenu = function isc_TabSet_showTabPickerMenu() {
        if (!this.$8d) {
            var _1 = this.tabs, _2 = [];
            for (var i = 0; i < _1.length; i++) {
                _2[i] = {index: i, enabled: !this.tabs[i].disabled, checkIf: "this.tabSet.getSelectedTabNumber() == " + i, title: _1[i].pickerTitle || _1[i].title, icon: (this.canCloseTab(_1[i]) ? null : _1[i].icon), click: "menu.tabSet.selectTab(item.index)"}
            }
    ...
    , isc.A.$8i = function isc_TabSet__showTab(_1) {
        ...
        if (_1 && _1.pane) {
            if (!this.paneContainer.hasMember(_1.pane))
                this.paneContainer.addMember(_1.pane);
            _1.pane.show()
        }
    ...
    , isc.A.$8c = function isc_TabSet__tabSelected(_1) {
        var _2;
        var _3 = this.getSelectedTab(), _4 = this.getSelectedTabNumber(), _5 = this._tabBar.getButtonNumber(_1), _6 = this.getTabObject(_5), _7 = (_3 != null) && (_6 != _3);
        ...
        _12.scrollTabIntoView(_5, null, this.animateTabScrolling, function() {
            if (isc.isA.Function(_13.tabScrolledIntoView))
                _13.tabScrolledIntoView()
        })
    }
    ...
    , isc.A.getSelectedTabNumber = function isc_TabSet_getSelectedTabNumber() {
        if (!isc.isA.Number(this.selectedTab))
            this.selectedTab = this.getTabNumber(this.selectedTab);
        if (!this.tabs || !this.tabs[this.selectedTab])
            return-1;
    ...
    , isc.A.$798 = function isc_TabSet__editTabTitle(_1) {
        ...
        if (_2)
            this.editTabTitle(_1);
        return _2
    }
    , isc.A.editTabTitle = function isc_TabSet_editTabTitle(_1) {
        _1 = this.getTab(_1);
        if (_1 == null || !this.tabBar)
            return;
        if (!isc.isA.DynamicForm(this.titleEditorForm)) {
            var _2 = isc.addProperties({}, this.titleEditorDefaults, this.titleEditorProperties, {handleKeyPress: function(_8, _9) {
            ...
            _2.name = "title";
            this.titleEditorForm = isc.DynamicForm.create({autoDraw: false, margin: 0, padding: 0, cellPadding: 0, fields: [_2]});
        ...
        var _7 = _1.title;
        _6.setValue(_7);
        this.tabBar.scrollTabIntoView(_1, null, this.animateTabScrolling, {target: this, methodName: "showTitleEditor"})
    }
    ...
    , isc.A.saveTabTitle = function isc_TabSet_saveTabTitle() {
        if (this.titleEditorForm != null && this.titleEditorForm.isVisible() && this.titleEditorForm.isDrawn())
        {
            ...
            if (!_1)
                this.setTabTitle(_2.targetTab, _4)
        }
        this.clearTitleEditorForm()
    }
    ...
    , isc.A.showTitleEditor = function isc_TabSet_showTitleEditor() {
        ...
        var _3 = this.tabBar.getLeft() + this.tabBar.getLeftMargin() - this.tabBar.getScrollLeft() + this.tabBar.getLeftBorderSize() + _2.getLeft() + _2.capSize, _4 = _2.getVisibleWidth() - _2.capSize * 2;
    ...
    , isc.A.$804 = function isc_TabSet__clickOutsideDuringTitleEdit() {
        if (isc.EH.getTarget() == this.titleEditorForm)
            return;
        this.saveTabTitle()
    }
    ...
    isc.TabSet.registerStringMethods({tabSelected: "tabNum,tabPane,ID,tab", tabDeselected: "tabNum,tabPane,ID,tab,newTab", getPaneContainerEdges: "", onCloseClick: "tab", titleChanged: "newTitle,oldTitle,tab", showTabContextMenu: "tabSet,tab"});
    ...
    if (isc.Log && isc.Log.logIsInfoEnabled('loadTime'))
        isc.Log.logInfo('Containers module init time: ' + (isc._moduleEnd - isc._moduleStart) + 'ms', 'loadTime');
    delete isc.definingFramework;
} else {
    if (window.isc && isc.Log && isc.Log.logWarn)
        isc.Log.logWarn("Duplicate load of module 'Containers'.");
}
/*
 * Isomorphic SmartClient
 * Version v8.2p_2012-06-03 (2012-06-03)
