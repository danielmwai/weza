...
if (window.isc && window.isc.module_Core && !window.isc.module_Calendar) {
    ...
    if (isc._moduleEnd && (!isc.Log || (isc.Log && isc.Log.logIsDebugEnabled('loadTime')))) {
        isc._pTM = {message: 'Calendar load/parse time: ' + (isc._moduleStart - isc._moduleEnd) + 'ms', category: 'loadTime'};
    ...
    isc.A.mainViewDefaults = {_constructor: isc.TabSet, defaultWidth: "80%", defaultHeight: "100%", tabBarAlign: "right", selectedTab: 1};
    isc.A.dateChooserConstructor = "DateChooser";
    isc.A.eventDialogDefaults = {_constructor: isc.Window, showHeaderIcon: false, showMinimizeButton: false, showMaximumButton: false, canDragReposition: true, overflow: "visible", bodyProperties: {overflow: "visible"}, width: 400, height: 100};
    isc.A.eventEditorDefaults = {_constructor: isc.DynamicForm, padding: 4, numCols: 4, showInlineErrors: false, width: 200};
    isc.A.eventEditorLayoutDefaults = {_constructor: isc.Window, showHeaderIcon: false, showShadow: false, showMinimizeButton: false, showMaximumButton: false, canDragReposition: false};
    isc.A.addEventButtonDefaults = {_constructor: isc.ImgButton, title: "", src: "[SKINIMG]actions/add.png", showRollOver: false, showDown: false, showFocused: false, width: 16, height: 16};
    isc.A.datePickerButtonDefaults = {_constructor: isc.ImgButton, title: "", src: "[SKIN]/controls/date_control.gif", width: 16, height: 16, showRollOver: false, showFocused: false};
    isc.A.controlsBarDefaults = {_constructor: isc.HLayout, defaultLayoutAlign: "center", height: 25, membersMargin: 5};
    isc.A.previousButtonDefaults = {_constructor: isc.ImgButton, title: "", src: "[SKINIMG]actions/back.png", showFocused: false, width: 16, height: 16, click: "this.creator.previous()", showRollOver: false, showDown: false};
    isc.A.nextButtonDefaults = {_constructor: isc.ImgButton, title: "", src: "[SKINIMG]actions/forward.png", showFocused: false, width: 16, height: 16, click: "this.creator.next()", showRollOver: false, showDown: false};
    ...
    isc.B.push(isc.A.initWidget = function isc_Calendar_initWidget() {
        ...
        if (!this.initialCriteria && this.autoFetchData)
            this.initialCriteria = this.getNewCriteria();
        this.setData(null);
    ...
    , isc.A.clearTimeSelection = function isc_Calendar_clearTimeSelection() {
        if (this.dayView)
            this.dayView.clearSelection();
        if (this.weekView)
            this.weekView.clearSelection()
    }
    ...
    , isc.A.canEditEvent = function isc_Calendar_canEditEvent(_1) {
        if (!_1)
            return false;
        else if (_1[this.canEditField] != null)
            return _1[this.canEditField];
        else
    ...
    , isc.A.removeEvent = function isc_Calendar_removeEvent(_1, _2) {
        ...
        var _6 = function() {
            ...
            if (_5.eventAutoArrange) {
                if (_5.dayView)
                    _5.dayView.refreshEvents();
                if (_5.weekView)
                    _5.weekView.refreshEvents()
            }
            if (_5.eventRemoved)
                _5.eventRemoved(_1)
        }
    ...
    , isc.A.$64i = function isc_Calendar__findEventWindow(_1, _2) {
        var _3 = (_2 ? this.weekView : this.dayView);
        if (!_3.body || !_3.body.children)
            return;
        var _4 = _3.body.children;
        if (this.dataSource)
            this.$53s = isc.DataSource.get(this.dataSource).getLocalPrimaryKeyFields();
        for (var i = 0; i < _4.length; i++) {
    ...
    , isc.A.$64j = function isc_Calendar__prepareAutoArrangeOffsets(_1, _2) {
        var _3 = [], _4 = 60 / this.eventSnapGap, _5 = 24 * _4, _6 = [new Array(_5), new Array(_5), new Array(_5), new Array(_5), new Array(_5), new Array(_5), new Array(_5)];
        for (var i = 0; i < _5; i++) {
            _3.add({usedCol: [0, 0, 0, 0, 0, 0, 0], assignedCol: [0, 0, 0, 0, 0, 0, 0], exactTime: [0, 0, 0, 0, 0, 0, 0]})
        }
        for (var i = 0; i < _1.getLength(); i++) {
            var _8 = _1.get(i);
            var _9 = _8[this.startDateField].getDay();
            var _10 = _8[this.startDateField].getUTCHours(), _11 = _8[this.startDateField].getUTCMinutes(), _12 = _11 % this.eventSnapGap;
            if (_12) {
                _11 = _11 - _12
            }
            if (_10 == 24)
                _10 = 0;
            var _13 = _8[this.endDateField].getDay(), _14 = _8[this.endDateField].getUTCHours(), _15 = _8[this.endDateField].getUTCMinutes(), _16 = _15 % this.eventSnapGap;
            if (_13 > _9) {
                _14 = 24;
                _15 = 0;
                _16 = 0
    ...
    , isc.A.$64n = function isc_Calendar__renderEventRange(_1, _2, _3) {
        ...
        for (var i = 0; i < _9.getLength(); i++) {
            ...
            if (this.weekEventBorderOverlap && _4.$53i)
                _21 += 1;
            if (_14.getMinutes() > 0) {
    ...
    , isc.A.getNewCriteria = function isc_Calendar_getNewCriteria() {
        ...
        if (this.fetchMode == "timeline") {
            ...
            var _3 = {_constructor: "AdvancedCriteria", operator: "and", criteria: [{fieldName: this.startDateField, operator: "greaterThan", value: _2.startDate}, {fieldName: this.endDateField, operator: "lessThan", value: _2.endDate}]};
    ...
    , isc.A.$53a = function isc_Calendar__setWeekTitles() {
        ...
        for (var i = 1; i < 8; i++) {
            if (this.weekView.getFieldNum("day" + i) >= 0) {
                ...
                if (_5.match(this.$81i) != null)
                    _5 = _5.substring(5);
                else if (_5.match(this.$81j))
                    _5 = _5.substring(0, _5.length - 5)
                var _6 = _2[_1.getDay()] + " " + _5;
                var _7 = {title: _6, align: "right", $654: _1.getDay(), $658: _1.getDate(), $659: _1.getMonth(), $66a: _1.getFullYear()}
                this.weekView.setFieldProperties("day" + i, _7);
                if (this.weekView.header)
                    this.weekView.header.markForRedraw()
            }
    ...
    , isc.A.$653 = function isc_Calendar__getTabs() {
        ...
        if (this.showDayView != false) {
            this.dayView = this.createAutoChild("dayView", {baseStyle: this.baseStyle, viewName: "day", cellHeight: this.rowHeight});
            _1.add({title: this.dayViewTitle, pane: this.dayView, viewName: "day"})
        }
        if (this.showWeekView != false) {
            this.weekView = this.createAutoChild("weekView", {$53i: true, baseStyle: this.baseStyle, viewName: "week", cellHeight: this.rowHeight});
            _1.add({title: this.weekViewTitle, pane: this.weekView, viewName: "week"})
        }
        if (this.showMonthView != false) {
            this.monthView = this.createAutoChild("monthView", {baseStyle: this.baseStyle, viewName: "month", bodyConstructor: "MonthScheduleBody"});
            _1.add({title: this.monthViewTitle, pane: this.monthView, viewName: "month"})
        }
        if (this.showTimelineView != false) {
            this.timelineView = this.createAutoChild("timelineView", {baseStyle: this.baseStyle, viewName: "timeline"});
    ...
    , isc.A.$655 = function isc_Calendar__createTabSet(_1) {
        if (_1.length > 1) {
            this.mainView = this.createAutoChild("mainView", {tabs: _1, tabSelected: function(_3, _4, _5, _6) {
    ...
    , isc.A.createChildren = function isc_Calendar_createChildren() {
        ...
        if (this.showControlsBar != false) {
            ...
            this.addEventButton = this.createAutoChild("addEventButton", {click: function() {
                    var _3 = this.creator;
                    ...
                    if (_4 == "day") {
                        ...
                        if (_5.getHours() > 22) {
                            ...
                            _5.setHours(_5.getHours() + 1)
                    } else if (_4 == "month") {
                        _6.setDate(1);
                        if (_6.getTime() > _5.getTime())
                            _5 = _6
                    }
            ...
            this.datePickerButton = this.createAutoChild("datePickerButton", {click: function() {
                    var _3 = this.creator;
                    if (this.$54x) {
                        this.$54x.setData(_3.chosenDate);
                        this.$54x.draw()
                    } else {
                        this.$54x = isc.DateChooser.create({calendar: this.creator, autoDraw: false, showCancelButton: true, autoClose: true, disableWeekends: this.creator.disableWeekends, firstDayOfWeek: this.creator.firstDayOfWeek, showWeekends: this.creator.showWeekends, dateClick: function(_37, _38, _39) {
        ...
        var _10 = [];
        if (this.showPreviousButton != false)
            _10.add(this.previousButton);
        if (this.showDateDisplay != false)
            _10.add(this.dateDisplay);
        if (this.showDatePickerButton != false)
            _10.add(this.datePickerButton);
        if (this.canCreateEvents && this.showAddEventButton != false)
            _10.add(this.addEventButton);
        if (this.showNextButton != false)
            _10.add(this.nextButton);
        if (this.showControlsBar != false) {
            this.controlsBar = this.createAutoChild("controlsBar", {members: _10})
        }
        this.dateChooser = this.createAutoChild("dateChooser", {disableWeekends: this.disableWeekends, showWeekends: this.showWeekends, chosenDate: this.chosenDate, month: this.month, year: this.year, dateClick: function(_37, _38, _39) {
                var _9 = new Date(_37, _38, _39);
                this.setData(_9);
        ...
        this.eventDialog = this.createAutoChild("eventDialog", {items: [isc.DynamicForm.create({autoDraw: false, padding: 4, calendar: this, saveOnEnter: true, useAllDataSourceFields: true, $642: ["name"], getCustomValues: function() {
                        if (!this.calendar.eventDialogFields)
                            return;
                        var _11 = this.$642;
                        ...
                        var _16 = [{name: _3.nameField, title: _3.eventNameFieldTitle, type: _15, width: 250}, {name: "save", title: _3.saveButtonTitle, type: "SubmitItem", endRow: false}, {name: "details", title: _3.detailsButtonTitle, type: "button", startRow: false, click: function(_25, _38) {
                        ...
                        var _3 = this.calendar, _18 = _3.eventDialog.event, _19 = _3.eventDialog.currentStart, _20 = _3.eventDialog.currentEnd;
                        if (!this.validate())
                            return;
                        if (_18) {
        ...
        this.eventEditor = this.createAutoChild("eventEditor", {useAllDataSourceFields: true, initWidget: function() {
                ...
                return _23
            }, $642: ["startHours", "startMinutes", "startAMPM", "endHours", "endMinutes", "endAMPM", "name", "description"], getCustomValues: function() {
        ...
        this.eventEditorLayout = this.createAutoChild("eventEditorLayout", {items: [this.eventEditor, isc.HLayout.create({membersMargin: 10, layoutMargin: 10, autoDraw: false, members: [isc.IButton.create({autoDraw: false, title: this.saveButtonTitle, calendar: this, click: function() {
                                var _3 = this.calendar, _18 = _3.eventEditorLayout.event, _25 = _3.eventEditor, _26 = _25.getItem("startHours").getValue(), _27 = _25.getItem("endHours").getValue(), _28 = _25.getItem("startMinutes").getValue(), _29 = _25.getItem("endMinutes").getValue();
                                var _30, _31;
                            ...
                            }}), isc.IButton.create({autoDraw: false, title: this.cancelButtonTitle, calendar: this, click: function() {
                ...
                if (this.creator.twentyFourHourTime)
                    return _37;
                else
                    return this.creator.$53n(_37)
                ...
                this.Super('hide');
                if (this.creator.dayView)
                    this.creator.dayView.clearSelection();
                if (this.creator.weekView)
                    this.creator.weekView.clearSelection();
        ...
        if (this.showDateChooser) {
            _34.add(isc.VLayout.create({autoDraw: false, width: "20%", membersMargin: 10, layoutTopMargin: 10, members: _35}))
        }
        if (this.mainView.isA("TabSet")) {
            _34.add(this.mainView)
        } else {
            if (this.showControlsBar != false) {
                var _36 = isc.HLayout.create({autoDraw: false, height: this.controlsBar.getVisibleHeight(), width: "100%"});
    ...
    , isc.A.monthViewEventClick = function isc_Calendar_monthViewEventClick(_1, _2, _3) {
        ...
        var _5 = _4[_3];
        if (this.eventClick(_5, "month"))
            this.$53j(_5)
    }
    , isc.A.getDayBodyHTML = function isc_Calendar_getDayBodyHTML(_1, _2, _3, _4, _5) {
        var _6 = _1.getDay();
        var _7 = _2, _8 = 15, _9 = this.monthView.data ? this.monthView.data[1] : null, _10 = this.monthView.getRowHeight(_9, 1);
        var _11 = "";
        for (var i = 0; i < _7.length; i++) {
    ...
    , isc.A.parentResized = function isc_Calendar_parentResized() {
        ...
        if (this.eventEditorLayout.isVisible())
            this.eventEditorLayout.sizeMe()
    }
    ...
    , isc.A.setTimelineRange = function isc_Calendar_setTimelineRange(_1, _2, _3, _4, _5) {
        if (this.timelineView)
            this.timelineView.setTimelineRange(_1, _2, _3, _4);
        if (_5)
            this.fireCallback(_5)
    }
    );
    isc.B._maxIndex = isc.C + 82;
    isc.ClassFactory.defineClass("DaySchedule", "ListGrid");
    isc.DaySchedule.changeDefaults("bodyProperties", {childrenSnapToGrid: true, snapToCells: true, redrawOnResize: true});
    ...
    isc.B.push(isc.A.initWidget = function isc_DaySchedule_initWidget() {
        this.fields = [];
        var _1 = {width: this.labelColumnWidth, name: "label", title: " ", cellAlign: "right", formatCellValue: function(_9, _10, _11, _12, _13) {
                if (_11 % 2 == 0) {
                    var _2 = (_11 / 2);
    ...
    , isc.A.cellMouseDown = function isc_DaySchedule_cellMouseDown(_1, _2, _3) {
        if (this.isLabelCol(_3) || this.colDisabled(_3))
            return true;
        var _4 = this.creator.$53m(this.getEventRow(), this.getEventColumn());
        if (this.creator.backgroundMouseDown && this.creator.backgroundMouseDown(_4) == false)
            return;
        if (!this.creator.canCreateEvents)
            return true;
        this.clearSelection();
        this.$53q = {};
        this.$53q.colNum = _3;
    ...
    , isc.A.getCellStyle = function isc_DaySchedule_getCellStyle(_1, _2, _3) {
        ...
        if (this.isLabelCol(_3))
            return _4;
        if (this.colDisabled(_3))
            return this.baseStyle + "Disabled";
    ...
    , isc.A.getBaseStyle = function isc_DaySchedule_getBaseStyle(_1, _2, _3) {
        ...
        var _5 = this.$53i ? this.getDateFromCol(_3) : this.creator.chosenDate.duplicate(), _6 = _5.duplicate(), _7 = _5.duplicate(), _8 = isc.Time.parseInput(this.creator.workdayStart), _9 = isc.Time.parseInput(this.creator.workdayEnd);
    ...
    , isc.A.refreshEvents = function isc_DaySchedule_refreshEvents() {
        if (!this.body || !this.creator.hasData())
            return;
    ...
    , isc.A.sizeEventWindow = function isc_DaySchedule_sizeEventWindow(_1) {
        ...
        if (!_1.$53v) {
            if (_2.eventAutoArrange) {
                ...
                if (_2.weekEventBorderOverlap && _1.$53i)
                    _10 += 1;
    ...
    , isc.A.updateEventWindow = function isc_DaySchedule_updateEventWindow(_1) {
        ...
        if (_3.dataSource)
            _3.$53s = _3.getDataSource().getLocalPrimaryKeyFields();
        for (var i = 0; i < _2.length; i++) {
    ...
    isc.MonthSchedule.changeDefaults("headerButtonProperties", {showRollOver: false, showDown: false, cursor: "default"});
    ...
    isc.B.push(isc.A.initWidget = function isc_MonthSchedule_initWidget() {
        if (this.creator.data)
            this.data = this.getDayArray();
        this.fields = [{name: "day1", align: "center"}, {name: "day2", align: "center"}, {name: "day3", align: "center"}, {name: "day4", align: "center"}, {name: "day5", align: "center"}, {name: "day6", align: "center"}, {name: "day7", align: "center"}];
    ...
    , isc.A.getDayArray = function isc_MonthSchedule_getDayArray() {
        ...
        this.$53t = 0;
        for (var i = 0; i < 6; i++) {
            if (this.creator.showDayHeaders)
                _1.add(this.getHeaderRowObject(_4));
            _1.add(this.getEventRowObject(_4, _2));
            this.incrementDate(_4, 7);
            if (_4.getMonth() != this.creator.month)
                break
        }
        return _1
    }
    ...
    , isc.A.rowIsHeader = function isc_MonthSchedule_rowIsHeader(_1) {
        var _2 = this.creator;
        if (!_2.showDayHeaders || (_2.showDayHeaders && _1 % 2 == 1))
            return false;
        else
            return true
    }
    , isc.A.formatCellValue = function isc_MonthSchedule_formatCellValue(_1, _2, _3, _4) {
        var _5 = this.creator, _6 = this.fields.get(_4).$66b, _7 = _2["event" + _6], _8 = _2["date" + _6], _9 = _8.getMonth() != _5.chosenDate.getMonth();
    ...
    , isc.A.getRowHeight = function isc_MonthSchedule_getRowHeight(_1, _2) {
        ...
        if (this.rowIsHeader(_2)) {
            ...
            var _4 = _3 ? this.data.length / 2 : this.data.length, _5 = _3 ? this.body.getViewportHeight()
                    - (this.dayHeaderHeight * _4) : this.body.getViewportHeight(), _6 = _3 ? this.mimimumDayHeight - this.dayHeaderHeight : this.minimumDayHeight;
            if (_5 / _4 <= _6) {
                return _6
            } else {
    ...
    , isc.A.getBaseStyle = function isc_MonthSchedule_getBaseStyle(_1, _2, _3) {
        ...
        if (this.rowIsHeader(_2)) {
            if ((_2 == 0 && _1["day" + _5] > 7) || (_2 == this.data.length - 2 && _1["day" + _5] < 7)) {
                if (!_4.showOtherDays)
                    return _4.otherDayBlankStyle;
                else
                    _6 = _4.otherDayHeaderBaseStyle
            } else
                _6 = _4.dayHeaderBaseStyle
        } else {
            ...
            if ((_2 == _8 && this.data[_8]["day" + _5] > 7) || (_2 == _9 && this.data[_9]["day" + _5] < 7)) {
                if (!_4.showOtherDays)
                    ...
                    _6 = _7 ? _4.otherDayBodyBaseStyle + "Disabled" : _4.otherDayBodyBaseStyle
            } else
                _6 = _7 ? _4.dayBodyBaseStyle + "Disabled" : _4.dayBodyBaseStyle
        }
        return _6
    }
    , isc.A.cellClick = function isc_MonthSchedule_cellClick(_1, _2, _3) {
        var _4 = this.creator, _5, _6, _7 = this.fields.get(_3).$66b, _8 = _1["date" + _7], _9 = _1["event" + _7], _10 = _4.chosenDate.getMonth() != _8.getMonth(), _11 = false;
        if (this.rowIsHeader(_2)) {
    ...
    , isc.A.click = function isc_EventWindow_click() {
        ...
        if (_2) {
            if (!_1.canEditEvent(this.event))
                return;
            if (this.$53i)
                _1.weekView.clearSelection();
            else
                _1.dayView.clearSelection();
            var _3 = _1.weekView.isLabelCol(0) ? 1 : 0;
            var _4 = this.$53i ? this.event[_1.startDateField].getDay() -
                    _1.firstDayOfWeek + _3 : _3;
            if (this.$53i && _1.showWeekends == false)
                _4--;
    ...
    , isc.A.dragRepositionStop = function isc_EventWindow_dragRepositionStop() {
        ...
        var _4 = this.ns.EH, _5 = this.parentElement.getEventColumn(), _6 = (_4.dragMoveTarget.getTop() - this.parentElement.getPageTop()) + this.parentElement.getScrollTop(), _7 = this.parentElement.getRowSize(1), _8 = Math.floor(_6 / _7), _9 = (this.$53i ? _1.weekView : _1.dayView);
        if (_9.isLabelCol(_5) || _9.colDisabled(_5))
            return false;
        ...
        if (!_1.eventMoved(_10, this.event))
            return false;
    ...
    , isc.A.dragResizeStop = function isc_EventWindow_dragResizeStop() {
        ...
        var _4 = this.ns.EH, _5 = this.parentElement.getEventColumn(), _6 = (_4.dragMoveTarget.getTop() - this.parentElement.getPageTop()) + this.parentElement.getScrollTop() + _4.dragMoveTarget.getVisibleHeight(), _7 = this.parentElement.getRowSize(1), _8 = Math.floor(_6 / _7);
        var _9 = _1.$53m(_8, _5);
        var _10 = Math.floor((_6 - (_7 * _8)) * (30 / _7));
        _9.setMinutes(_9.getMinutes() + _10);
        _9 = _1.getValidSnapDate(this.event[_1.endDateField], _9);
        if (_4.dragMoveTarget.getVisibleHeight() < _7)
            return false;
        if (!_1.eventResized(_9, this.event))
            return false;
    ...
    , isc.A.draw = function isc_TimelineWindow_draw(_1, _2, _3, _4) {
        ...
        if (this.calendar.showEventWindowHeader == false) {
            var _5 = isc.Canvas.create({autoDraw: false, width: "100%", height: 0, top: 0, contents: (this.descriptionText ? this.descriptionText : " ")});
            this.addMember(_5);
            _5.setHeight(0);
            _5.setTop(0);
            this.$734 = _5
    ...
    , isc.A.dragRepositionStop = function isc_TimelineWindow_dragRepositionStop() {
        ...
        if (_5[_4.leadingDateField])
            _6[2].setMinutes(_6[2].getMinutes() + _12);
        if (_5[_4.trailingDateField])
            _6[3].setMinutes(_6[3].getMinutes() + _12);
        var _13 = {}
        if (_2)
            _13[_4.eventTypeField] = _2;
        if (_5[_4.leadingDateField] && _5[_4.trailingDateField]) {
            _13[_4.leadingDateField] = _6[2];
            _13[_4.trailingDateField] = _6[3]
        }
        if (_2 == null)
            _2 = _5[_4.eventTypeField];
        ...
        if (!_4.timelineEventMoved(_5, this, _6[0], _6[1], _2))
            return false;
    ...
    , isc.A.dragResizeStop = function isc_TimelineWindow_dragResizeStop() {
        var _1 = this.calendar, _2, _3, _4 = this.ns.EH, _5, _6 = this.getPageLeft() - this.getLeft(), _7 = _4.dragMoveTarget.getLeft() - _6;
        if (_7 == this.getLeft()) {
        ...
        if (!_1.timelineEventResized(this.event, this, _2, _3))
            return false;
    ...
    isc.TimelineView.changeDefaults("bodyProperties", {childrenSnapToGrid: true, snapToCells: false, suppressVSnapOffset: true});
    ...
    isc.B.push(isc.A.initWidget = function isc_TimelineView_initWidget() {
        this.fields = [];
        if (this.creator.eventTypeField)
            this.eventTypeField = this.creator.eventTypeField;
        if (this.creator.timelineStartDate)
            this.startDate = this.creator.timelineStartDate;
        if (this.creator.timelineEndDate)
            this.endDate = this.creator.timelineEndDate;
        if (this.creator.renderEventsOnDemand)
    ...
    , isc.A.setTimelineRange = function isc_TimelineView_setTimelineRange(_1, _2, _3, _4) {
        ...
        if (_3)
            this.creator.timelineGranularity = _3;
        if (_4)
            this.creator.timelineUnitsPerColumn = _4;
    ...
    , isc.A.calcFields = function isc_TimelineView_calcFields() {
        ...
        while (_5.getTime() <= _6.getTime()) {
            var _9 = isc.addProperties({name: "f" + _7, title: this.getDayFieldTitle(_5), width: this.eventWidth}, this.getFieldProperties(_5));
            _1.add(_9);
    ...
    , isc.A.tagDataForOverlap = function isc_TimelineView_tagDataForOverlap(_1, _2) {
        ...
        _1.sort(function(_19, _20) {
            var _9;
            if (_19[_3.leadingDateField] && _20[_3.leadingDateField])
                _9 = _3.leadingDateField;
            else
                _9 = _3.startDateField;
            if (_19[_3.eventTypeField] < _20[_3.eventTypeField])
                return-1;
            else if (_19[_3.eventTypeField] > _20[_3.eventTypeField])
                return 1;
            else {
    ...
    , isc.A.eventsOverlap = function isc_TimelineView_eventsOverlap(_1, _2) {
        ...
        if (_1[_5.leadingDateField] && _2[_5.leadingDateField])
            _3 = _5.leadingDateField;
        else
            _3 = _5.startDateField;
        if (_1[_5.trailingDateField] && _2[_5.trailingDateField])
            _4 = _5.trailingDateField;
        else
            _4 = _5.endDateField;
        if (_5.equalDatesOverlap) {
            if (_1[_4] < _2[_3] || _1[_3] > _2[_4])
                return false;
            else
                return true
        } else {
    ...
    , isc.A.sizeEventWindow = function isc_TimelineView_sizeEventWindow(_1, _2) {
        ...
        if (_4[_3.leadingDateField] && _4[_3.trailingDateField]) {
            if (_1.$645)
                this.addLeadingAndTrailingLines(_1);
            else
                this.delayCall("addLeadingAndTrailingLines", [_1])
        }
    }
    ...
    , isc.A.$65t = function isc_TimelineView__positionIcon(_1, _2) {
        var _3 = this.creator, _4 = _1.$65e, _5 = _4.event, _6 = _1.type, _7 = this.eventWidth, _8 = _4.getVisibleHeight(), _9 = _4.getTop(), _10 = _4.getLeft();
        ...
        if (_13 == false)
            ...
            _17 = _10 + _7 + _12 - Math.round(_16 / 2);
        else
            _17 = _10 - _12 - Math.round(_16 / 2);
    ...
    , isc.A.$65s = function isc_TimelineView__makeIcon(_1, _2) {
        ...
        var _4 = isc.Img.create({$65e: _1, type: _2, autoDraw: false, _redrawWithParent: false, src: (_2 == "trail" ? this.trailingEndPointImage : this.leadingEndPointImage), width: _3, height: _3, canDragReposition: (this.creator.canEditEvents == true), dragRepositionStart: function() {
                this.$8l = this.parentElement.getEventRow();
                this.$644 = this.parentElement.getEventColumn();
                this.parentElement.VSnapOrigin = this.$647;
                this.parentElement.HSnapOrigin = this.$648
            }, dragRepositionStop: function() {
                var _5 = this.$65f, _6 = this.$644, _7 = this.parentElement.getEventColumn(), _8 = _7 - _6, _9 = this.$65e.event, _10 = this.$65e.calendar, _11 = this.type == "trail" ? _7 - _5 : _5 - _7;
                if (_11 < 1)
                    return false;
                var _12 = {};
    ...
    , isc.A.$65r = function isc_TimelineView__makeLine() {
        var _1 = isc.Canvas.create({autoDraw: false, _redrawWithParent: false, height: 2, overflow: "hidden", styleName: "eventLine"});
        return _1
    }
    , isc.A.clearEvents = function isc_TimelineView_clearEvents(_1) {
        if (!this.body || !this.body.children || !this.$65u)
            return;
        if (!_1)
            _1 = 0;
    ...
    , isc.A.getNewEventWindow = function isc_TimelineView_getNewEventWindow(_1) {
        ...
        var _7 = {calendar: this.creator, _redrawWithParent: false, styleName: _2, canDragReposition: _6, canDragResize: this.creator.canResizeTimelineEvents, edgeMarginSize: 10, showCloseButton: false, event: _1, descriptionText: _1[this.creator.descriptionField] || "", showHeader: _5, showBody: _5}
    ...
    , isc.A.updateEventWindow = function isc_TimelineView_updateEventWindow(_1) {
        if (!this.body || !this.body.children)
            return;
        var _2 = this.creator, _3 = this.tagDataForOverlap(_2.data.getRange(0, _2.data.getLength()), _1[_2.eventTypeField]);
    ...
    if (isc.Log && isc.Log.logIsInfoEnabled('loadTime'))
        isc.Log.logInfo('Calendar module init time: ' + (isc._moduleEnd - isc._moduleStart) + 'ms', 'loadTime');
    delete isc.definingFramework;
} else {
    if (window.isc && isc.Log && isc.Log.logWarn)
        isc.Log.logWarn("Duplicate load of module 'Calendar'.");
}
/*
 * Isomorphic SmartClient
 * Version v8.2p_2012-06-03 (2012-06-03)
